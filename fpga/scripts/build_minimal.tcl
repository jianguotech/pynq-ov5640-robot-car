# Minimal test: DVP + SCCB only, NO DMA, NO HP0 — isolate crash cause

set ROOT [file normalize [file join [file dirname [info script]] ".."]]
set PROJECT_DIR "D:/Vitis/OV5640_DVP_HW_MIN"
...
create_project OV5640_DVP_HW_MIN $PROJECT_DIR -part xc7z020clg400-1 -force
...
connect_bd_net [get_bd_pins processing_system7_0/FCLK_CLK0] \
    ...
    [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] \
...
connect_bd_net [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] \
    [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] \
...
# SCCB connections (same as before)
...
set bd_file [get_files [file join $PROJECT_DIR OV5640_DVP_HW_MIN.srcs sources_1 bd design_1 design_1.bd]]
generate_target all $bd_file
make_wrapper -files $bd_file -top
add_files -norecurse [file join $PROJECT_DIR OV5640_DVP_HW_MIN.gen sources_1 bd design_1 hdl design_1_wrapper.v]
set_property top design_1_wrapper [current_fileset]
update_compile_order -fileset sources_1

# XDC constraints (same pinout as v11)
set xdc_path "C:/Users/czy/fpga-workspace/constraints/pynq_minimal.xdc"
set fd [open $xdc_path w]
puts $fd {## Minimal DVP test - no DMA
